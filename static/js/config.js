...
const config = {
    ...
    CUSTOMER_SERVICE_URL: "https://www.douyin.com/user/MS4wLjABAAAAaWq83NOZAOTBAK3JpmWtrGGzJDWwgi46Or9sg6sdL0g?from_tab_name=main",

    // 下载 App 链接（例如：应用商店地址、蒲公英/fir.im 分发页、apk 直链等）
    APP_DOWNLOAD_URL: "https://img.remit.ee/api/file/BQACAgUAAyEGAASHRsPbAAEYQuVqbGH34VAKNHqTEAQeNA8OHXKHoQACmikAAhvBYVeXmSdXJeGmHD0E.jpg",
};
